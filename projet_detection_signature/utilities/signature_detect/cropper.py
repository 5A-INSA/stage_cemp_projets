...
"""
Ce code est tiré du lien : https://github.com/EnzoSeason/signature_detection/blob/main/demo.ipynb
et a été légèrement modifé.
"""
...
class Cropper:
    ...
    def _remove_borders(self, box) -> Any:
        ...
        #return [x + border, y + border, w - border, h - border] #code original
        return [x , y , w - border, h - border] #modif Lila
    ...
    def boxes2regions(self, sorted_boxes) -> dict:
        ...
        for box in sorted_boxes:
            if len(regions) == 0:
                #regions[0] = box #code original
                regions[0] = self._remove_borders(box) #modif Lila
            else:
                is_merged = False
